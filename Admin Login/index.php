...
<head>
  ...
  <script defer type="text/javascript" src="../Assets/JS_Admin_Login.js"></script>
  ...
  <title>EACMed - Admin Login</title>
</head>
<body>
    ...
    <form action="" id="StudentLoginForm" class="FormLogin" method="POST" autocomplete="off">
      <div class="form-login-div">
        ...
        <div class="input-div">
          ...
          <input type="text" onkeyup="inputText('LoginUsername')" id="AdminUsername" class="input-text input-LoginUsername">
        ...
        <div class="input-div">
          ...
          <input type="password" onkeyup="inputText('LoginPassword')" class="input-text input-LoginPassword passwordInput" id="AdminPassword">
